...
# --- 1. Structura de date si Functii de Incarcare ---
...
def trebuie_sa_fie_inainte(c1, c2):
    ...
    # Criteriul 2: Timp crescator (daca punctajele sunt egale)
    if c1["timp"] < c2["timp"]:
        return True
    if c1["timp"] > c2["timp"]:
        return False
...
# --- 4. Afisare, Clasament si Statistici ---
...
# --- 5. Meniul Interactiv si Fluxul Aplicatiei ---
def meniu():
